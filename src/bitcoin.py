...
data_in, data_out,  all_data= read_data(input_file,RANGE, OUT_LEN, use_saved = False)
# plt.plot(data_in)
# plt.show()
...
rnn = RnnModel(chunk_size_ = 20, max_len_sent = RANGE, rnn_size_ = 40, classes= OUT_LEN)
